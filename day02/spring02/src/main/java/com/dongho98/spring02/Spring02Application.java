...
public class Spring02Application {
	...
	public static void main(String[] args) {
		...
		score[4] = 85; // 4번 째 인덱스 값을 83 -> 85로 변경
		...
		// Java 컬렉션으로 변경
		List<String> car_list = Array.asList(carcompany);
		...
		Array.sort(carcompany, Collections.reverseOrder()); // 내림차순 정렬
		for (String car : carcompany) {
			System.out.println(car);
		}
	}
